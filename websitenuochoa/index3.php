...
<!DOCTYPE html>
  ...
  <head>
    <title>Perfume | Thế giới nước hoa</title>
    <meta charset="utf-8">
  ...
  <body class="goto-here">
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Perfume</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <a class="nav-link dropdown-toggle" href="#nuochoanu" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Nước hoa</a>
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="#nuochoanu">Nước hoa nữ</a>
                <a class="dropdown-item" href="#nuochoanam">Nước hoa nam</a>
    			...
    			<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product d-flex flex-column">
    					...
    					<div class="text py-3 pb-4 px-3">
    						...
    						<h3><a href="#"><?php echo $value['mansx'] + $value['tensanpham']?></a></h3>
    						<div class="pricing">
	    						<p class="price"><span><?php echo $value['gia'] + $value['dungtich'] ?></span></p>
	    					</div>
	...
	<!-- <section class="ftco-section bg-light" id="nuochoanam">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <p>Những điều thú vị về các chàng trai</p>
          </div>
        </div>   		
    	</div>
    	<div class="container">
    		<div class="row">
    			<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product d-flex flex-column">
    					<a href="#" class="img-prod"><img class="img-fluid" src="/websitenuochoa/public/frontend/images/nuochoanam1.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3">
    						<div class="d-flex">
    			...
    			<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product d-flex flex-column">
    					<a href="#" class="img-prod"><img class="img-fluid" src="/websitenuochoa/public/frontend/images/nuochoanam2.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3">
    						<div class="d-flex">
    			...
    			<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="/websitenuochoa/public/frontend/images/nuochoanam3.jpg" alt="Colorlib Template">
	    					<div class="overlay"></div>
	    				</a>
    					<div class="text py-3 pb-4 px-3">
    						<div class="d-flex">
    			...
    			<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="/websitenuochoa/public/frontend/images/nuochoanam4.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3">
    						<div class="d-flex">
    ...
    <section class="ftco-section ftco-deal bg-primary" id="sanphamkhuyenmai">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6">
    				<img src="/websitenuochoa/public/frontend/images/nuochoanam5.jpg" class="img-fluid" alt="">
    			</div>
    			<div class="col-md-6">
