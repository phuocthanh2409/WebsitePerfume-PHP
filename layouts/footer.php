        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">The Perfume</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">Nước hoa nam</a></li>
                <li><a href="#" class="py-2 d-block">Nước hoa nữ</a></li>
                <!-- <li><a href="#" class="py-2 d-block">Sản phẩm khuyến mãi</a></li>
                <li><a href="#" class="py-2 d-block">Sản phẩm mới</a></li> -->
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">theperfume@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
